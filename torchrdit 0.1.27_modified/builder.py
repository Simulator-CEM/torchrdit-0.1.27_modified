...
class SolverBuilder:
    ...
    def __init__(self):
        ...
        self._is_use_Li = False
        self._device = "cpu"
        self._layers = []
        self._rdit_order = None
        self._rdit_Norm_M = None
    ...
    def with_zigzag(self, use_Li: bool) -> "SolverBuilder":
        """Set whether to use Fast Fourier Factorization for improved convergence.
    ...
    def with_rdit_Norm_M(self, Norm_M: int) -> "SolverBuilder":
        """Set the normalized norm2 for the R-DIT algorithm.
        
        setting similar to the rdit_order
            
        ```
        
        Keywords:
            R-DIT, normalized norm2, convergence, approximation, accuracy, performance
        """
        self._rdit_Norm_M = Norm_M
        return self
    ...
    def from_config(self, config: Union[str, Dict[str, Any]], flip: bool = False) -> "SolverBuilder":
        ...
        if "use_Li" in case_insensitive_config:
            self._is_use_Li = case_insensitive_config["use_Li"][1]
        ...
        if "rdit_Norm_M" in case_insensitive_config:
            self._rdit_Norm_M = case_insensitive_config["rdit_Norm_M"][1]    
    ...
    def build(self):
        ...
        if self._algorithm_type == Algorithm.RCWA:
            ...
            # Set RDIT Norm_M if specified
            if self._rdit_Norm_M is not None:
                solver.set_rdit_Norm_M(self._rdit_Norm_M)
