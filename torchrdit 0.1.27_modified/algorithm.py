...
class RDITAlgorithm(SolverAlgorithm):
    ...
    def __init__(self, solver):
        ...
        self._rdit_Norm_M = 0  # Default value
    ...
    def solve_nonhomo_layer(self, layer_thickness, p_mat_i, q_mat_i, mat_w0, mat_v0, kdim, k_0, **kwargs):
        ...
        Norm_M=self._rdit_Norm_M
        Scaling_M=2**Norm_M
        delta_h=delta_h/ Scaling_M
        ...
        for Index in range(1,Norm_M+1):
            Tmat_a_i=tmat_a_i @ tmat_a_i+tmat_b_i @ tmat_c_i
            Tmat_b_i=tmat_a_i @ tmat_b_i+tmat_b_i @ tmat_d_i
            Tmat_c_i=tmat_c_i @ tmat_a_i+tmat_d_i @ tmat_c_i
            Tmat_d_i=tmat_c_i @ tmat_b_i+tmat_d_i @ tmat_d_i
            tmat_a_i=Tmat_a_i
            tmat_b_i=Tmat_b_i
            tmat_c_i=Tmat_c_i
            tmat_d_i=Tmat_d_i
    ...
    def set_rdit_Norm_M(self,rdit_Norm_M):
        """Set the normalization of the norm2 of the matrix of the R-DIT algorithm.
        
        Norm_M can iprove the condition number thus reduce the Taylor orders and also the convergence speed
        Larger order of the R-DIT algorithm can leads to divergent results.
        """
        self._rdit_Norm_M = rdit_Norm_M